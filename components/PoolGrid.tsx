...
export default function PoolGrid({
  ...
  // Desktop lg+: Larger cells to match sidebar height
  const cellSize = 'w-[calc((100vw-28px)/11)] h-[calc((100vw-28px)/11)] sm:w-[calc((100vw-48px)/11)] sm:h-[calc((100vw-48px)/11)] lg:w-[74px] lg:h-[74px] xl:w-[80px] xl:h-[80px] 2xl:w-[86px] 2xl:h-[86px]';
