            ...
            <div className="text-left mb-8">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#cda33b]/20 text-[#9a7b1c] flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5">
                    1
                  </div>
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#cda33b]"></div>
      </div>
    }>
      <ThankYouContent />
    </Suspense>
