...
DROP TRIGGER IF EXISTS update_grid_squares_updated_at ON grid_squares;
DROP TRIGGER IF EXISTS update_payments_updated_at ON payments;
DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;

DROP TABLE IF EXISTS quarterly_winners CASCADE;
DROP TABLE IF EXISTS purchase_activity CASCADE;
DROP TABLE IF EXISTS payments CASCADE;
DROP TABLE IF EXISTS grid_squares CASCADE;
DROP TABLE IF EXISTS profiles CASCADE;
DROP TABLE IF EXISTS settings CASCADE;
DROP TABLE IF EXISTS admin_users CASCADE;

DROP INDEX IF EXISTS idx_grid_squares_status;
DROP INDEX IF EXISTS idx_grid_squares_user_id;
DROP INDEX IF EXISTS idx_payments_user_id;
DROP INDEX IF EXISTS idx_payments_status;
DROP INDEX IF EXISTS idx_purchase_activity_created_at;
DROP INDEX IF EXISTS idx_quarterly_winners_quarter;
...
CREATE INDEX idx_grid_squares_user_id ON grid_squares(user_id);
CREATE INDEX idx_payments_user_id ON payments(user_id);
CREATE INDEX idx_payments_status ON payments(status);
CREATE INDEX idx_purchase_activity_created_at ON purchase_activity(created_at DESC);
CREATE INDEX idx_quarterly_winners_quarter ON quarterly_winners(quarter);
...
INSERT INTO settings (key, value) VALUES
    ...
    ('prize_q3', '250.00'),
    ('prize_q4', '250.00'),
    ('venmo_username', '@michaelwilliamsscholarship'),
